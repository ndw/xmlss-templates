...
<xsl:template match="html:head">
  <xsl:copy>
    ...
    <xsl:apply-templates/>
		...
		<link rel="stylesheet" href="ui/xmlss/slides.css" type="text/css" media="projection"
					id="slideProj" />
		<link rel="stylesheet" href="ui/xmlss/outline.css" type="text/css" media="screen"
					id="outlineStyle" />
		<link rel="stylesheet" href="ui/xmlss/print.css" type="text/css" media="print"
					id="slidePrint" />
		<link rel="stylesheet" href="ui/xmlss/opera.css" type="text/css" media="projection"
					id="operaFix" />
